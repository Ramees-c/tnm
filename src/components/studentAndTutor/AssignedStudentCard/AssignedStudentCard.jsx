...
function AssignedStudentCard({
  ...
  return (
    <div className="p-5 bg-white rounded-md shadow-md hover:shadow-lg transition flex flex-col sm:flex-row sm:items-center justify-between gap-6 border border-gray-100">
